class Autogenerated {
	...
	Autogenerated({this.batchcomplete, this.continues, this.query});

	Autogenerated.fromJson(Map<String, dynamic> json) {
		batchcomplete = json['batchcomplete'];
		continues = json['continue'] != null ? new Continue.fromJson(json['continue']) : null;
	...
	Map<String, dynamic> toJson() {
      ...
      data['continue'] = this.continues.toJson();
    }
		if (this.query != null) {
...
class Continue {
	...
	Continue({this.gpsoffset, this.continues});
